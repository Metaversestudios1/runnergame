  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(
        ...
        }/api/shop/items?page=${page}&limit=${pageSize}&search=${search}`
      );
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center">
        <div className="text-2xl font-bold mx-2 my-8 px-4">Items</div>
      </div>
                ...
                return (
                  <tr className="bg-white">
                    ...
                    <td className=" p-5   border-2  border-gray-300">
                      <div className="flex items-center">
                        <NavLink to={`/items/edititem/${item?._id}`}>
      ...
      {noData && (
        <div className="text-center text-xl">
          Currently! There are no items in the storage.
        </div>
      )}
      {items.length !== 0 && (
        <div className="flex flex-col items-center my-10">
          ...
          <div className="inline-flex mt-2 xs:mt-0">
            ...
            <button
              ...
              onClick={() => setPage(page + 1)}
              disabled={
                items.length < pageSize || startIndex + pageSize >= count
              }
            >
              Next
            </button>
