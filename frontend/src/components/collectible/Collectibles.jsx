  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(
        ...
        }/api/getAllCollectible?page=${page}&limit=${pageSize}&search=${search}`
      );
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center">
        <div className="text-2xl font-bold mx-2 my-8 px-4">Collectible List</div>
      </div>
      <div className="flex justify-between">
        <NavLink to="/collectibles/addcollectible">
